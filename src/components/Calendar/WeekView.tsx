  ...
  return (
    <div
      style={{
        position: 'absolute',
        top,
        height: bloque.diaCom ? '100%' : height,
        left: 0, right: 0,
        ...
        pointerEvents: 'none',
        display: 'flex',
        alignItems: bloque.diaCom ? 'center' : 'flex-start',
        justifyContent: bloque.diaCom ? 'center' : 'flex-start',
        padding: '4px 6px',
        fontSize: 11,
        color: '#E5484D',
        fontWeight: 600,
        overflow: 'hidden',
        textAlign: bloque.diaCom ? 'center' : 'left',
        lineHeight: 1.3,
      }}
