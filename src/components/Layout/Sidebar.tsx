  ...
  return (
    <aside className={'sidebar' + (abierto ? ' sidebar--abierto' : '')}>
      ...
      <div className="sb-links">
        {/* Panel: solo admin y supervisor */}
        {puedeVerCatalogo && (
          <SidebarBtn to="/admin/dashboard" label="Panel" colorKey="panel" onClick={onNavegar}/>
        )}
        ...
        {puedeVerCatalogo && (
          <SidebarSection
            ...
            colorKey="catalogo"
            rutas={['/admin/tipo-categorias', '/admin/categorias', '/admin/servicios', '/admin/productos', '/admin/descuentos', '/admin/prestador-servicios']}
          >
            ...
            <SidebarBtn to="/admin/descuentos"          label="Descuentos"     colorKey="descuentos" onClick={onNavegar}/>
